...
class Body(tk.Frame):
    ...
    def _draw(self):
        ...
        self.message_editor = tk.Text(master=message_frame, height=3)
        self.message_editor.pack(fill=tk.BOTH, side=tk.TOP, expand=False)
        


class Footer(tk.Frame):
    def __init__(self, root, add_callback=None, delete_callback=None, open_callback=None):
        tk.Frame.__init__(self, root)
        self.root = root
    ...
    def _draw(self):
        ...
        self.open_button = tk.Button(master=self, text="Open", width=20, command=self.open_click)
        self.open_button.pack(fill=tk.BOTH, side=tk.RIGHT, padx=5, pady=5)
...
class MainApp(tk.Frame):
    ...
    def _draw(self):
        ...
        self.footer = Footer(self.root, add_callback=self.add_clicked, delete_callback=self.delete_clicked, open_callback=self.open_clicked)
